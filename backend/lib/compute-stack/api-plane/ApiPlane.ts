...
const setupHttpApi = (
  ...
  // create api
  apiPlane.contactsApi = new apiGwV2.CfnApi(apiPlane, "ChatAppContactsApi", {
    body: {
      openapi: "3.0.1",
      info: {
  ...
  // create test stage
  new apiGwV2.CfnStage(apiPlane, "ChatAppContactsApiTestStage", {
    apiId: apiPlane.contactsApi.ref,
    stageName: "test",
    autoDeploy: true,
  });
};
