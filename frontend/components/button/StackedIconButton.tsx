import { Center, CenterProps, Text, Grid } from "@chakra-ui/react";
...
export const StackedIconButton = (props: IconButtonProps) => {
  return (
    <Center
      as="button"
    ...
    >
      <Grid>
        ...
        <Text fontSize="sm" fontWeight="medium" color="brand.gray.700">
          {props.children}
        </Text>
      </Grid>
    </Center>
